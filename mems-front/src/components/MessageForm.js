                ...
                <div className="col-md-6 px-5 mt-4">
                    <form action="/message/create" method="POST" onSubmit={this.handleSubmit}>
                        ...
                        <div className="input-group mb-3">
                            <input id="message-content" className="form-control text-white border-primary bg-primary" type="text" name="content" autoComplete="off" value={content} onChange={this.handleChange} />
